oS.Init({
    ...
    backgroundImage: "https://gongjv.jun-ye.top/zhiwudazhanjiangsi/images/interface/Logo.png",
    LoadAccess: function(a) {
        NewEle(0, "div", "width:225px;height:44px;margin:550px 0 0 694px;position:absolute;z-index:1;background:url(https://gongjv.jun-ye.top/zhiwudazhanjiangsi/images/interface/version.png)", 0, $("tGround"));
        EBody = document.body;
