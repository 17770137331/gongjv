...
GotoAuthorWebsite = function() {
   /* alert("可以收藏一下！"); */
   window.open("http://www.baidu.com/link?url=XcUsFxBXr0Evcu_W1oOK2-dPEOSfgEnMK3FEK1Ci5Vq&wd=&eqid=ce99b38200082ae50000000362b7b20c");
    return
},
InitGame = function() {
    ...
    a = $("dProcess"); ! $("dText1") && a.insertBefore(NewEle("dText1", "div", 0, {
        innerHTML: '<span style="line-height:23px;font-size:15px;font-family:&#x9ED1;&#x4F53;;color:#F60;top:32px">欢迎体验<span style="font-family:Verdana;font-weight:700">新版植物大战僵尸</span>,程序是玩家自制,与任何盈利公司无关。<span style="font-family:Verdana;font-weight:700"></span>保留对该程序版权所有,游戏题材、素材、音效归轻语诉永恒，执意画红尘所有，个别背景音乐来源免费音乐网站。如您需要转载，请保留以上版权说明，不然视盗版处理。</span>'
    },
    0), a.firstChild);
    LoadLvl()
},
